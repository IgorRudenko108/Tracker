(() => {
    ...
    (() => {
        ...
        const asideMenuBurger = document.querySelector(".icon-menu");
        const asideBody = document.querySelector(".aside");
        const sliderBody = document.querySelector(".content-slider");
        if (asideMenuBurger) asideMenuBurger.addEventListener("click", (function(e) {
